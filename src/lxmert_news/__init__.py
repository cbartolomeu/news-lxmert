...
if is_torch_available():
    _import_structure["modeling_lxmert"] = [
        "LxmertNewsEncoder",
        "LxmertNewsForPreTraining",
        "LxmertNewsForQuestionAnswering",
        "LxmertNewsModel",
        "LxmertNewsPreTrainedModel",
        "LxmertNewsVisualFeatureEncoder",
        "LxmertNewsXLayer",
    ]
...
if TYPE_CHECKING:
    from .configuration_lxmert import LXMERT_PRETRAINED_CONFIG_ARCHIVE_MAP, LxmertNewsConfig
